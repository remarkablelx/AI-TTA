...
def main():
    ...
    # =================================================================
    # --- MODIFIED START: Custom output path logic ---
    # =================================================================
    output_file = None
    # Define a base name for output files
    if args.input == 'webcam':
        input_name_without_ext = 'webcam'
    else:
        input_name_without_ext = os.path.splitext(
            os.path.basename(args.input))[0]

    # Set video output path if output_root is provided
    if args.output_root:
        mmengine.mkdir_or_exist(args.output_root)
        # 视频输出路径
        output_file = os.path.join(
            args.output_root, f'{input_name_without_ext}_pose_detect.mp4')
